...
class GridTwoDimensionalScroller extends StatefulWidget {
  const GridTwoDimensionalScroller({
    Key? key,
  }) : super(key: key);

  @override
  State<GridTwoDimensionalScroller> createState() =>
      _GridTwoDimensionalScrollerState();
}

class _GridTwoDimensionalScrollerState
    extends State<GridTwoDimensionalScroller> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      floatingActionButton: FloatingActionButton(
        onPressed: () {
          horizontalController.animateTo(500,
